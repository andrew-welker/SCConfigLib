...
namespace SCConfigSPlus
{
    public class CameraConfigurationReader
    {
        ...
        /// </summary>
        public CamerasConfigChangedDel OnConfigurationChanged { get; set; }
        ...
        /// <summary>
        /// Method to read the Camera Settings
        /// </summary>
        public void ReadSettings()
        {
            var reader = new JsonSettingsReader(_fileName);

            var sources = reader.LoadSection<List<Camera>>(_sectionName);
        ...
        private void FireOnConfigChangedEvent(IList<Camera> settings)
        {
