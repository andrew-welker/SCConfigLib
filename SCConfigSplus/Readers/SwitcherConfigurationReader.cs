...
{
    public class SwitcherConfigurationReader
    {
        ...
        /// </summary>
        public event SwitcherControlsConfigChangedDel OnConfigurationChanged;
        ...
        public void ReadSettings()
        {
            ...
            var settings = reader.LoadSection<Switcher>();
        ...
        private void FireOnConfigChangedEvent(Switcher settings)
        {
