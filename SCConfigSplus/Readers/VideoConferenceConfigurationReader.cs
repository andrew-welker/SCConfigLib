...
{
    public class VideoConferenceConfigurationReader
    {
        ...
        /// </summary>
        public event VtcControlsConfigChangedDel OnConfigurationChanged;
        ...
        /// <summary>
        /// Method to read the Video Conference settings
        /// </summary>
        public void ReadSettings()
        {
            var reader = new JsonSettingsReader(_filePath);
            var settings = reader.LoadSection<VideoConference>();
        ...
        private void FireOnConfigChangedEvent(VideoConference settings)
        {
